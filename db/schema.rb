...
ActiveRecord::Schema.define(version: 2023_04_01_214656) do
  ...
  create_table "followings", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.index ["student_id"], name: "index_followings_on_student_id"
    t.index ["teacher_id", "student_id"], name: "index_followings_on_teacher_id_and_student_id", unique: true
  ...
  add_foreign_key "followings", "students"
